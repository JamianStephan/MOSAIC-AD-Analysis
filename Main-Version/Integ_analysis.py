...
def observation_transmission(wavelengths,transmissions):
    integ_transmission=[]
...
def integ_trans(analysis,aperturecentre_waverefs,guide,parallatic,centre_index=0): 
    ...
    for aperture_val in aperturecentre_waverefs:
        ...
        integ_transmission=observation_transmission(analysis.output['wavelengths'],analysis.output['transmissions'])
    ...
    analysis.calculate_transmissions()
    opt_transmission=observation_transmission(analysis.output['wavelengths'],analysis.output['transmissions'])
